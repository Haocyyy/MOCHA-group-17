...
Respondent <- data_names %>%   
  ...
  full_join(Region, by = c("Country" = "Country", 
                           "Region"="Region", 
                           "City_size"="City_size")) 
...
Respondent = subset(Respondent,   
                    select = -c(Q5_4_other,Q44UK,Q44NL,Q44NL_6_other, 
                                Q44DE,Q44ES,Q44PL,Qcountry, 
                                Q3UK,Q3NL,Q3DE,Q3ES,Q3PL, 
                                City_size,Region,Country) )  
...
Respondent <- Respondent[, c(1,8,2,3,4,5,6,7,9)]  
Respondent$Health_consumption<- as.integer(  
  Respondent$Health_consumption)  
